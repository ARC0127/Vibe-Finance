...
> 数据截点：`2026-08-13T22:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.7290 | ¥5,674.80 | +57.40 |
| 510500 | 南方中证500ETF | 400 | ¥7.6653 | ¥7.9800 | ¥3,192.00 | +125.90 |
| 510880 | 华泰柏瑞上证红利ETF | 1100 | ¥3.2235 | ¥3.2730 | ¥3,600.30 | +54.40 |
| 512100 | 南方中证1000ETF | 900 | ¥2.8380 | ¥3.1280 | ¥2,815.20 | +261.00 |
| 518880 | 华安黄金易ETF | 200 | ¥9.0950 | ¥9.0420 | ¥1,808.40 | -10.60 |
| 588000 | 华夏上证科创板50成份ETF | 1300 | ¥1.8674 | ¥1.8120 | ¥2,355.60 | -72.00 |
...
> 每日策略日期：**2026-08-13**；决策截点：`2026-08-13T16:30:00+08:00`；策略版本：`v0.3.1`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-08-13.json`](data/inbox/2026-08-13.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 518880 | 华安黄金易ETF | 加仓 | 6.0% | `COLD_START_GOLD_DIVERSIFIER`；历史仍处于冷启动；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.7% | 历史仍处于冷启动；`SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |
| 510500 | 南方中证500ETF | 持有 | 10.5% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 11.9% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
| 512100 | 南方中证1000ETF | 持有 | 9.3% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
...
决策报告：[`2026-08-13-short.json`](reports/daily/2026-08-13-short.json)。

### 今日执行与订单

- 开盘结算截点：`2026-08-13T09:30:27+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 买入 `588000` 100 份；原因：`COLD_START_TREND`。
- 执行报告：[`2026-08-13-open.json`](reports/execution/2026-08-13-open.json)。
- 当前账本待执行订单：**1** 笔。
...
> 这是依据 **2026-08-13** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
