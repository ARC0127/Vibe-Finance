...
> 数据截点：`2026-07-30T08:00:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
> 每日策略日期：**2026-07-30**；决策截点：`2026-07-30T08:00:00+08:00`；策略版本：`v0.3.1`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-07-30-preopen.json`](data/inbox/2026-07-30-preopen.json)。
...
决策报告：[`2026-07-30-preopen.json`](reports/preopen/2026-07-30-preopen.json)。
...
> 这是依据 **2026-07-30** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
