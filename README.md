...
> 数据截点：`2026-09-16T09:32:24+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6632 | ¥0.6510 | ¥2,278.50 | -42.62 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.5220 | ¥5,426.40 | -191.00 |
| 510500 | 南方中证500ETF | 300 | ¥7.7072 | ¥7.5830 | ¥2,274.90 | -37.25 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.3850 | ¥4,400.50 | +170.27 |
| 512100 | 南方中证1000ETF | 1200 | ¥2.9111 | ¥3.0220 | ¥3,626.40 | +133.10 |
| 518880 | 华安黄金易ETF | 200 | ¥9.0411 | ¥8.8280 | ¥1,765.60 | -42.61 |
...
> 每日策略日期：**2026-09-16**；决策截点：`2026-09-16T08:00:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-09-16-preopen.json`](data/inbox/2026-09-16-preopen.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 518880 | 华安黄金易ETF | 持有 | 8.9% | `COLD_START_GOLD_DIVERSIFIER`；盘前交易状态待核验 |
| 159928 | 汇添富中证主要消费ETF | 持有 | 7.7% | 盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.3% | 盘前交易状态待核验；`SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |
| 510500 | 南方中证500ETF | 持有 | 7.7% | 盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 14.8% | 盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 512100 | 南方中证1000ETF | 持有 | 12.3% | 盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 159915 | 易方达创业板ETF | 观察 | 0.0% | 受控回撤信号；盘前交易状态待核验；`MAXIMUM_POSITIONS_REACHED` |
| 588000 | 华夏上证科创板50成份ETF | 观察 | 0.0% | 冷启动趋势信号；盘前交易状态待核验；`MAXIMUM_POSITIONS_REACHED` |
...
决策报告：[`2026-09-16-preopen.json`](reports/preopen/2026-09-16-preopen.json)。

### 今日执行与订单

- 开盘结算截点：`2026-09-16T09:32:24+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 卖出 `518880` 100 份；原因：`DAILY_WEAKNESS_ROTATION`。
- 执行报告：[`2026-09-16-open.json`](reports/execution/2026-09-16-open.json)。
- 当前账本待执行订单：**0** 笔。
...
> 这是依据 **2026-09-16** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
