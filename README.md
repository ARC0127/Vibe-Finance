...
> 数据截点：`2026-09-10T16:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6632 | ¥0.6670 | ¥2,334.50 | +13.38 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.6170 | ¥5,540.40 | -77.00 |
| 510500 | 南方中证500ETF | 300 | ¥7.7072 | ¥7.7420 | ¥2,322.60 | +10.45 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.4730 | ¥4,514.90 | +284.67 |
| 512100 | 南方中证1000ETF | 1100 | ¥2.8960 | ¥3.0820 | ¥3,390.20 | +204.60 |
| 518880 | 华安黄金易ETF | 300 | ¥9.0831 | ¥9.0830 | ¥2,724.90 | -0.03 |
...
> 每日策略日期：**2026-09-10**；决策截点：`2026-09-10T16:30:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-09-10T16:14:36+08:00`。
...
点时输入：[`2026-09-10.json`](data/inbox/2026-09-10.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 518880 | 华安黄金易ETF | 减仓 | 9.1% | `COLD_START_GOLD_DIVERSIFIER`；`DAILY_WEAKNESS_ROTATION` |
| 159928 | 汇添富中证主要消费ETF | 持有 | 7.8% | 受控回撤信号 |
...
| 159915 | 易方达创业板ETF | 观察 | 0.0% | `TREND_NOT_CONFIRMED`；每日小额探索；`MAXIMUM_POSITIONS_REACHED` |
| 510880 | 华泰柏瑞上证红利ETF | 观察 | 15.0% | 正向趋势信号；每日小额探索；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 512100 | 南方中证1000ETF | 观察 | 11.3% | `TREND_NOT_CONFIRMED`；每日小额探索；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
...
决策报告：[`2026-09-10-short.json`](reports/daily/2026-09-10-short.json)。

### 今日执行与订单

- 开盘结算截点：`2026-09-10T09:32:16+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 买入 `510500` 100 份；原因：`COLD_START_TREND`。
- 执行报告：[`2026-09-10-open.json`](reports/execution/2026-09-10-open.json)。
- 当前账本待执行订单：**1** 笔。

### 场外基金周期

- 最新净值周期：**2026-09-09** `2026-09-09T22:30:00+08:00`；扫描 7 只场外基金，可执行信号 0 个。
- 天天基金只作净值、申赎、费率等交叉检查；详情见 [`2026-09-09-funds.json`](reports/funds/2026-09-09-funds.json)。
...
> 这是依据 **2026-09-10** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
