...
> 数据截点：`2026-08-12T16:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.7480 | ¥5,697.60 | +80.20 |
| 510500 | 南方中证500ETF | 400 | ¥7.6653 | ¥8.0530 | ¥3,221.20 | +155.10 |
| 510880 | 华泰柏瑞上证红利ETF | 1100 | ¥3.2235 | ¥3.3030 | ¥3,633.30 | +87.40 |
| 512100 | 南方中证1000ETF | 900 | ¥2.8380 | ¥3.1560 | ¥2,840.40 | +286.20 |
| 518880 | 华安黄金易ETF | 200 | ¥9.0950 | ¥9.1030 | ¥1,820.60 | +1.60 |
| 588000 | 华夏上证科创板50成份ETF | 1200 | ¥1.8642 | ¥1.8330 | ¥2,199.60 | -37.40 |
...
> 每日策略日期：**2026-08-12**；决策截点：`2026-08-12T16:30:00+08:00`；策略版本：`v0.3.1`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-08-12T16:14:45+08:00`。
...
点时输入：[`2026-08-12.json`](data/inbox/2026-08-12.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 588000 | 华夏上证科创板50成份ETF | 加仓 | 7.2% | 历史仍处于冷启动；冷启动趋势信号 |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.7% | 历史仍处于冷启动；`SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 11.9% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
| 518880 | 华安黄金易ETF | 持有 | 6.0% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
...
| 510500 | 南方中证500ETF | 观察 | 10.6% | 历史仍处于冷启动；冷启动趋势信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 159928 | 汇添富中证主要消费ETF | 观察 | 0.0% | 历史仍处于冷启动；冷启动趋势信号；`MAXIMUM_POSITIONS_REACHED` |
...
决策报告：[`2026-08-12-short.json`](reports/daily/2026-08-12-short.json)。

### 今日执行与订单

- 开盘结算截点：`2026-08-12T09:30:15+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 买入 `518880` 200 份；原因：`COLD_START_DEFENSIVE`。
- 执行报告：[`2026-08-12-open.json`](reports/execution/2026-08-12-open.json)。
- 当前账本待执行订单：**1** 笔。

### 场外基金周期

- 最新净值周期：**2026-08-11** `2026-08-11T22:30:00+08:00`；扫描 7 只场外基金，可执行信号 0 个。
- 天天基金只作净值、申赎、费率等交叉检查；详情见 [`2026-08-11-funds.json`](reports/funds/2026-08-11-funds.json)。
...
> 这是依据 **2026-08-12** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
