...
> 数据截点：`2026-08-14T16:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.7260 | ¥5,671.20 | +53.80 |
| 510500 | 南方中证500ETF | 400 | ¥7.6653 | ¥7.9980 | ¥3,199.20 | +133.10 |
| 510880 | 华泰柏瑞上证红利ETF | 1100 | ¥3.2235 | ¥3.2960 | ¥3,625.60 | +79.70 |
| 512100 | 南方中证1000ETF | 900 | ¥2.8380 | ¥3.1450 | ¥2,830.50 | +276.30 |
| 518880 | 华安黄金易ETF | 300 | ¥9.0487 | ¥8.9460 | ¥2,683.80 | -30.80 |
| 588000 | 华夏上证科创板50成份ETF | 1300 | ¥1.8674 | ¥1.8140 | ¥2,358.20 | -69.40 |
...
> 每日策略日期：**2026-08-14**；决策截点：`2026-08-14T16:30:00+08:00`；策略版本：`v0.3.1`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-08-14T16:14:30+08:00`。
...
点时输入：[`2026-08-14.json`](data/inbox/2026-08-14.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 510880 | 华泰柏瑞上证红利ETF | 加仓 | 11.9% | 历史仍处于冷启动；冷启动趋势信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.7% | 历史仍处于冷启动；`SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |
| 518880 | 华安黄金易ETF | 持有 | 8.8% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
| 588000 | 华夏上证科创板50成份ETF | 持有 | 7.8% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
| 159915 | 易方达创业板ETF | 观察 | 0.0% | 历史仍处于冷启动；冷启动趋势信号；`MAXIMUM_POSITIONS_REACHED` |
| 512100 | 南方中证1000ETF | 观察 | 9.3% | 历史仍处于冷启动；冷启动趋势信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
...
决策报告：[`2026-08-14-short.json`](reports/daily/2026-08-14-short.json)。

### 今日执行与订单

- 开盘结算截点：`2026-08-14T09:30:59+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 买入 `518880` 100 份；原因：`DAILY_EXPLORATION_FALLBACK`。
- 执行报告：[`2026-08-14-open.json`](reports/execution/2026-08-14-open.json)。
- 当前账本待执行订单：**1** 笔。

### 场外基金周期

- 最新净值周期：**2026-08-13** `2026-08-13T22:30:00+08:00`；扫描 7 只场外基金，可执行信号 0 个。
- 天天基金只作净值、申赎、费率等交叉检查；详情见 [`2026-08-13-funds.json`](reports/funds/2026-08-13-funds.json)。
...
> 这是依据 **2026-08-14** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
