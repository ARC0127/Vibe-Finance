...
> 数据截点：`2026-08-31T09:31:24+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6614 | ¥0.6710 | ¥2,348.50 | +33.64 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.6400 | ¥5,568.00 | -49.40 |
| 510500 | 南方中证500ETF | 300 | ¥7.6653 | ¥7.8500 | ¥2,355.00 | +55.42 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.4660 | ¥4,505.80 | +275.57 |
| 512100 | 南方中证1000ETF | 1100 | ¥2.8960 | ¥3.0950 | ¥3,404.50 | +218.90 |
| 518880 | 华安黄金易ETF | 300 | ¥9.0487 | ¥9.1600 | ¥2,748.00 | +33.40 |
...
2026-W35（8 月 24 日至 8 月 30 日）项目权益增加 **¥84.60（+0.278%）**，累计盈利 **¥512.10（+1.707%）**。股票型场内 ETF 净贡献 +¥58.50，黄金 ETF 贡献 +¥26.10；组合跑赢深证成指、创业板指和现金，落后于上证指数、科创 50 与上证 50。

本周 5/5 个交易日各完成一笔虚拟成交，五笔费用共 ¥25.00。科创 50 ETF 完成趋势退出，主要消费 ETF 建仓，中证 500 减仓，中证 1000 增持。当前 6 个持仓达到数量上限；中小盘成长桶占 19.126%，黄金桶占 9.347%，各风险桶均未越线。基金任务覆盖 5/5；天天基金当日 token 仍未与基金公司同日净值形成可接受配对，因此场外基金保持零交易。

首个完整持仓往返已经出现，但独立门禁判定 eligible sample 仍为 0，v0.4.0 本周不改参数。完整证据、资产类别归因、天天基金核验、基准比较与风险诊断见 [`2026-W35 周报`](reports/weekly/2026-W35.md)；机器可读版本见 [`2026-W35.json`](reports/weekly/2026-W35.json)。

<!-- VIBE_DAILY_STRATEGY:START -->
## 当前市场判断

> 每日策略日期：**2026-08-31**；决策截点：`2026-08-31T08:00:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-08-28T16:14:39+08:00`。
...
点时输入：[`2026-08-31-preopen.json`](data/inbox/2026-08-31-preopen.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 159928 | 汇添富中证主要消费ETF | 加仓 | 7.9% | 冷启动趋势信号；盘前交易状态待核验 |
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 14.8% | 正向趋势信号；盘前交易状态待核验 |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.5% | 盘前交易状态待核验；`SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |
| 159915 | 易方达创业板ETF | 观察 | 0.0% | 受控回撤信号；盘前交易状态待核验；`MAXIMUM_POSITIONS_REACHED` |
| 588000 | 华夏上证科创板50成份ETF | 观察 | 0.0% | 受控回撤信号；盘前交易状态待核验；`MAXIMUM_POSITIONS_REACHED` |
| 510500 | 南方中证500ETF | 观察 | 7.8% | 正向趋势信号；盘前交易状态待核验；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 512100 | 南方中证1000ETF | 观察 | 11.3% | 正向趋势信号；盘前交易状态待核验；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 518880 | 华安黄金易ETF | 观察 | 9.3% | 黄金分散条件通过；盘前交易状态待核验；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
...
决策报告：[`2026-08-31-preopen.json`](reports/preopen/2026-08-31-preopen.json)。

### 今日执行与订单

- 开盘结算截点：`2026-08-31T09:31:24+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 卖出 `159928` 100 份；原因：`DAILY_WEAKNESS_ROTATION`。
- 执行报告：[`2026-08-31-open.json`](reports/execution/2026-08-31-open.json)。
- 当前账本待执行订单：**0** 笔。

### 场外基金周期

- 最新净值周期：**2026-08-28** `2026-08-28T22:30:00+08:00`；扫描 7 只场外基金，可执行信号 0 个。
- 天天基金只作净值、申赎、费率等交叉检查；详情见 [`2026-08-28-funds.json`](reports/funds/2026-08-28-funds.json)。
...
> 这是依据 **2026-08-31** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
