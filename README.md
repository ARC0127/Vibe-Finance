...
> 数据截点：`2026-09-14T22:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6632 | ¥0.6570 | ¥2,299.50 | -21.62 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.5520 | ¥5,462.40 | -155.00 |
| 510500 | 南方中证500ETF | 300 | ¥7.7072 | ¥7.5980 | ¥2,279.40 | -32.75 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.4040 | ¥4,425.20 | +194.97 |
| 512100 | 南方中证1000ETF | 1100 | ¥2.8960 | ¥3.0330 | ¥3,336.30 | +150.70 |
| 518880 | 华安黄金易ETF | 300 | ¥9.0411 | ¥8.8750 | ¥2,662.50 | -49.82 |
...
> 每日策略日期：**2026-09-14**；决策截点：`2026-09-14T16:30:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-09-14T16:14:48+08:00`。
...
点时输入：[`2026-09-14.json`](data/inbox/2026-09-14.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 512100 | 南方中证1000ETF | 加仓 | 11.2% | 冷启动趋势信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION`；每日小额探索 |
...
| 510880 | 华泰柏瑞上证红利ETF | 观察 | 14.9% | `TREND_NOT_CONFIRMED`；每日小额探索；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
...
决策报告：[`2026-09-14-short.json`](reports/daily/2026-09-14-short.json)。

### 今日执行与订单

- 开盘结算截点：`2026-09-14T09:32:35+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 买入 `518880` 100 份；原因：`DAILY_EXPLORATION_FALLBACK`。
- 执行报告：[`2026-09-14-open.json`](reports/execution/2026-09-14-open.json)。
- 当前账本待执行订单：**1** 笔。
...
> 这是依据 **2026-09-14** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
