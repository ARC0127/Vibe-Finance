...
> 每日策略日期：**2026-07-24**；决策截点：`2026-07-24T22:30:00+08:00`；策略版本：`v0.3.1`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-07-24T16:14:51+08:00`。
...
点时输入：[`2026-07-24.json`](data/inbox/2026-07-24.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 510500 | 南方中证500ETF | 买入 | 0.0% | 历史仍处于冷启动；受控回撤信号 |
| 159915 | 易方达创业板ETF | 买入 | 0.0% | 历史仍处于冷启动；受控回撤信号 |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.9% | 历史仍处于冷启动；受控回撤信号 |
| 512100 | 南方中证1000ETF | 观察 | 7.6% | 历史仍处于冷启动；受控回撤信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
...
| 510880 | 华泰柏瑞上证红利ETF | 观察 | 0.0% | 历史仍处于冷启动；`TREND_NOT_CONFIRMED` |
...
决策报告：[`2026-07-24-short.json`](reports/daily/2026-07-24-short.json)。
