...
> 数据截点：`2026-09-09T09:32:18+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6632 | ¥0.6810 | ¥2,383.50 | +62.38 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.6380 | ¥5,565.60 | -51.80 |
| 510500 | 南方中证500ETF | 200 | ¥7.6653 | ¥7.8070 | ¥1,561.40 | +28.35 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.4460 | ¥4,479.80 | +249.57 |
| 512100 | 南方中证1000ETF | 1100 | ¥2.8960 | ¥3.1190 | ¥3,430.90 | +245.30 |
| 518880 | 华安黄金易ETF | 300 | ¥9.0831 | ¥8.9700 | ¥2,691.00 | -33.93 |
...
> 每日策略日期：**2026-09-09**；决策截点：`2026-09-09T08:00:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-09-09-preopen.json`](data/inbox/2026-09-09-preopen.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 510500 | 南方中证500ETF | 加仓 | 7.7% | 冷启动趋势信号；盘前交易状态待核验 |
...
决策报告：[`2026-09-09-preopen.json`](reports/preopen/2026-09-09-preopen.json)。

### 今日执行与订单

- 开盘结算截点：`2026-09-09T09:32:18+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 卖出 `510500` 100 份；原因：`DAILY_WEAKNESS_ROTATION`。
- 执行报告：[`2026-09-09-open.json`](reports/execution/2026-09-09-open.json)。
- 当前账本待执行订单：**0** 笔。
...
> 这是依据 **2026-09-09** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
