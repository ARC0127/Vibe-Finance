...
> 数据截点：`2026-08-19T08:00:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2387 | ¥3.2960 | ¥4,284.80 | +74.50 |
...
> 每日策略日期：**2026-08-19**；决策截点：`2026-08-19T09:09:59+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-08-19-0910-preopen.json`](data/inbox/2026-08-19-0910-preopen.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 14.1% | 历史仍处于冷启动；冷启动趋势信号；盘前交易状态待核验 |
...
决策报告：[`2026-08-19-preopen.json`](reports/preopen/guard/2026-08-19-preopen.json)。
...
> 这是依据 **2026-08-19** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
