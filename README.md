...
> 数据截点：`2026-08-11T13:07:16.980633+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.7580 | ¥5,709.60 | +92.20 |
| 510500 | 南方中证500ETF | 400 | ¥7.6653 | ¥8.0490 | ¥3,219.60 | +153.50 |
| 510880 | 华泰柏瑞上证红利ETF | 1100 | ¥3.2235 | ¥3.3170 | ¥3,648.70 | +102.80 |
| 512100 | 南方中证1000ETF | 900 | ¥2.8380 | ¥3.1410 | ¥2,826.90 | +272.70 |
| 588000 | 华夏上证科创板50成份ETF | 1200 | ¥1.8642 | ¥1.8310 | ¥2,197.20 | -39.80 |
...
> 每日策略日期：**2026-08-11**；决策截点：`2026-08-11T08:00:00+08:00`；策略版本：`v0.3.1`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-08-11-preopen-recovery-0816.json`](data/inbox/2026-08-11-preopen-recovery-0816.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 518880 | 华安黄金易ETF | 买入 | 0.0% | 历史仍处于冷启动；盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.7% | 历史仍处于冷启动；盘前交易状态待核验；`SECURITY_IDENTITY_NOT_CLEARED` |
| 588000 | 华夏上证科创板50成份ETF | 持有 | 7.2% | 历史仍处于冷启动；盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 510880 | 华泰柏瑞上证红利ETF | 观察 | 12.0% | 历史仍处于冷启动；冷启动趋势信号；盘前交易状态待核验 |
| 510500 | 南方中证500ETF | 观察 | 10.5% | 历史仍处于冷启动；冷启动趋势信号；盘前交易状态待核验 |
| 512100 | 南方中证1000ETF | 观察 | 9.2% | 历史仍处于冷启动；冷启动趋势信号；盘前交易状态待核验 |
...
决策报告：[`2026-08-11-preopen.json`](reports/preopen/recovery-0816/2026-08-11-preopen.json)。

### 今日执行与订单

- 开盘结算截点：`2026-08-11T13:07:16.980633+08:00`；实际虚拟成交 **0** 笔，取消 **1** 笔。
- `CANCELLED_DATA_GATE` 买入 `518880` 100 份；原因：`UNVERIFIED_SECURITY_IDENTITY_AND_ST_DELISTING`。
- 执行报告：[`2026-08-11-intraday.json`](reports/execution/2026-08-11-intraday.json)。
- 当前账本待执行订单：**0** 笔。
...
> 这是依据 **2026-08-11** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
