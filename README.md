...
> 数据截点：`2026-09-15T22:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6632 | ¥0.6540 | ¥2,289.00 | -32.12 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.5230 | ¥5,427.60 | -189.80 |
| 510500 | 南方中证500ETF | 300 | ¥7.7072 | ¥7.5880 | ¥2,276.40 | -35.75 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.3820 | ¥4,396.60 | +166.37 |
| 512100 | 南方中证1000ETF | 1200 | ¥2.9111 | ¥3.0240 | ¥3,628.80 | +135.50 |
| 518880 | 华安黄金易ETF | 300 | ¥9.0411 | ¥8.8290 | ¥2,648.70 | -63.62 |
...
> 每日策略日期：**2026-09-15**；决策截点：`2026-09-15T16:30:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-09-15T16:14:54+08:00`。
...
点时输入：[`2026-09-15.json`](data/inbox/2026-09-15.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 518880 | 华安黄金易ETF | 减仓 | 8.9% | `COLD_START_GOLD_DIVERSIFIER`；`DAILY_WEAKNESS_ROTATION` |
| 159928 | 汇添富中证主要消费ETF | 持有 | 7.7% | `TREND_NOT_CONFIRMED` |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.3% | `SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |
| 510500 | 南方中证500ETF | 持有 | 7.7% | `TREND_NOT_CONFIRMED` |
| 588000 | 华夏上证科创板50成份ETF | 观察 | 0.0% | 冷启动趋势信号；`MAXIMUM_POSITIONS_REACHED` |
| 511880 | 银华日利ETF | 观察 | 0.0% | 现金管理条件通过；`MAXIMUM_POSITIONS_REACHED` |
| 159915 | 易方达创业板ETF | 观察 | 0.0% | 受控回撤信号；`MAXIMUM_POSITIONS_REACHED`；每日小额探索 |
| 510880 | 华泰柏瑞上证红利ETF | 观察 | 14.8% | `TREND_NOT_CONFIRMED`；每日小额探索；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 512100 | 南方中证1000ETF | 观察 | 12.3% | `TREND_NOT_CONFIRMED`；每日小额探索；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 510050 | 华夏上证50ETF | 观察 | 0.0% | `SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |

其余 3 个低优先级观察项保留在机器报告中。

决策报告：[`2026-09-15-short.json`](reports/daily/2026-09-15-short.json)。

### 今日执行与订单

- 开盘结算截点：`2026-09-15T09:31:58+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 买入 `512100` 100 份；原因：`DAILY_EXPLORATION_FALLBACK`。
- 执行报告：[`2026-09-15-open.json`](reports/execution/2026-09-15-open.json)。
- 当前账本待执行订单：**1** 笔。

### 场外基金周期

- 最新净值周期：**2026-09-15** `2026-09-15T22:30:00+08:00`；扫描 7 只场外基金，可执行信号 0 个。
- 天天基金只作净值、申赎、费率等交叉检查；详情见 [`2026-09-15-funds.json`](reports/funds/2026-09-15-funds.json)。
...
> 这是依据 **2026-09-15** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
