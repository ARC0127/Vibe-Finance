...
点时输入：[`2026-07-27-preopen.json`](data/inbox/2026-07-27-preopen.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 510500 | 南方中证500ETF | 买入 | 0.0% | 历史仍处于冷启动；受控回撤信号；盘前交易状态待核验 |
| 159915 | 易方达创业板ETF | 买入 | 0.0% | 历史仍处于冷启动；受控回撤信号；盘前交易状态待核验 |
| 512480 | 国联安半导体ETF | 买入 | 0.0% | 历史仍处于冷启动；冷启动趋势信号；盘前交易状态待核验 |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.9% | 历史仍处于冷启动；受控回撤信号；盘前交易状态待核验 |
| 512100 | 南方中证1000ETF | 观察 | 7.6% | 历史仍处于冷启动；受控回撤信号；盘前交易状态待核验 |
...
| 510880 | 华泰柏瑞上证红利ETF | 观察 | 0.0% | 历史仍处于冷启动；盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
...
决策报告：[`2026-07-27-preopen.json`](reports/preopen/2026-07-27-preopen.json)。
