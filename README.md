...
> 数据截点：`2026-09-11T09:31:21+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6632 | ¥0.6650 | ¥2,327.50 | +6.38 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.5920 | ¥5,510.40 | -107.00 |
| 510500 | 南方中证500ETF | 300 | ¥7.7072 | ¥7.6840 | ¥2,305.20 | -6.95 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.4730 | ¥4,514.90 | +284.67 |
| 512100 | 南方中证1000ETF | 1100 | ¥2.8960 | ¥3.0570 | ¥3,362.70 | +177.10 |
| 518880 | 华安黄金易ETF | 200 | ¥9.0831 | ¥8.8950 | ¥1,779.00 | -37.62 |
...
> 每日策略日期：**2026-09-11**；决策截点：`2026-09-11T08:00:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-09-11-preopen.json`](data/inbox/2026-09-11-preopen.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 159928 | 汇添富中证主要消费ETF | 持有 | 7.8% | 受控回撤信号；盘前交易状态待核验 |
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 15.0% | 正向趋势信号；盘前交易状态待核验 |
| 518880 | 华安黄金易ETF | 持有 | 9.1% | `COLD_START_GOLD_DIVERSIFIER`；盘前交易状态待核验 |
...
| 512100 | 南方中证1000ETF | 持有 | 11.3% | 盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
...
决策报告：[`2026-09-11-preopen.json`](reports/preopen/2026-09-11-preopen.json)。

### 今日执行与订单

- 开盘结算截点：`2026-09-11T09:31:21+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 卖出 `518880` 100 份；原因：`DAILY_WEAKNESS_ROTATION`。
- 执行报告：[`2026-09-11-open.json`](reports/execution/2026-09-11-open.json)。
- 当前账本待执行订单：**0** 笔。
...
> 这是依据 **2026-09-11** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
