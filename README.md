...
> 数据截点：`2026-08-06T09:30:31+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.6880 | ¥5,625.60 | +8.20 |
| 510500 | 南方中证500ETF | 400 | ¥7.6653 | ¥7.7500 | ¥3,100.00 | +33.90 |
| 510880 | 华泰柏瑞上证红利ETF | 1100 | ¥3.2235 | ¥3.2270 | ¥3,549.70 | +3.80 |
| 512100 | 南方中证1000ETF | 900 | ¥2.8380 | ¥3.0000 | ¥2,700.00 | +145.80 |
| 588000 | 华夏上证科创板50成份ETF | 1200 | ¥1.8642 | ¥1.7500 | ¥2,100.00 | -137.00 |
...
> 每日策略日期：**2026-08-06**；决策截点：`2026-08-06T08:00:00+08:00`；策略版本：`v0.3.1`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-08-05T16:14:54+08:00`。
...
点时输入：[`2026-08-06-preopen.json`](data/inbox/2026-08-06-preopen.json)。
...
| 510500 | 南方中证500ETF | 持有 | 10.4% | 历史仍处于冷启动；盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 11.8% | 历史仍处于冷启动；盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
| 512100 | 南方中证1000ETF | 持有 | 9.1% | 历史仍处于冷启动；盘前交易状态待核验；`TREND_NOT_CONFIRMED` |
...
决策报告：[`2026-08-06-preopen.json`](reports/preopen/2026-08-06-preopen.json)。

### 今日执行与订单

- 开盘结算截点：`2026-08-06T09:30:31+08:00`；实际虚拟成交 **0** 笔，取消 **1** 笔。
- `CANCELLED_DATA_GATE` 买入 `510050` 1200 份；原因：`UNVERIFIED_SECURITY_IDENTITY_AND_ST_DELISTING`。
- 执行报告：[`2026-08-06-open.json`](reports/execution/2026-08-06-open.json)。
- 当前账本待执行订单：**0** 笔。
...
> 这是依据 **2026-08-06** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
