...
> 数据截点：`2026-09-08T16:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
|---|---|---:|---:|---:|---:|---:|
| 159928 | 汇添富中证主要消费ETF | 3500 | ¥0.6632 | ¥0.6830 | ¥2,390.50 | +69.38 |
| 510300 | 华泰柏瑞沪深300ETF | 1200 | ¥4.6812 | ¥4.6240 | ¥5,548.80 | -68.60 |
| 510500 | 南方中证500ETF | 300 | ¥7.6653 | ¥7.7880 | ¥2,336.40 | +36.82 |
| 510880 | 华泰柏瑞上证红利ETF | 1300 | ¥3.2540 | ¥3.4460 | ¥4,479.80 | +249.57 |
| 512100 | 南方中证1000ETF | 1100 | ¥2.8960 | ¥3.1060 | ¥3,416.60 | +231.00 |
| 518880 | 华安黄金易ETF | 300 | ¥9.0831 | ¥9.0470 | ¥2,714.10 | -10.83 |
...
> 每日策略日期：**2026-09-08**；决策截点：`2026-09-08T16:30:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。

### 市场温度

行情观测截至 `2026-09-08T16:14:48+08:00`。
...
点时输入：[`2026-09-08.json`](data/inbox/2026-09-08.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 510500 | 南方中证500ETF | 减仓 | 7.7% | 冷启动趋势信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION`；`DAILY_WEAKNESS_ROTATION` |
| 518880 | 华安黄金易ETF | 持有 | 9.0% | `COLD_START_GOLD_DIVERSIFIER` |
...
| 510880 | 华泰柏瑞上证红利ETF | 观察 | 14.9% | 正向趋势信号；每日小额探索；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
...
决策报告：[`2026-09-08-short.json`](reports/daily/2026-09-08-short.json)。

### 今日执行与订单

- 开盘结算截点：`2026-09-08T09:32:26+08:00`；实际虚拟成交 **1** 笔，取消 **0** 笔。
- `FILLED` 买入 `518880` 100 份；原因：`DAILY_EXPLORATION_FALLBACK`。
- 执行报告：[`2026-09-08-open.json`](reports/execution/2026-09-08-open.json)。
- 当前账本待执行订单：**1** 笔。

### 场外基金周期

- 最新净值周期：**2026-09-07** `2026-09-07T22:30:00+08:00`；扫描 7 只场外基金，可执行信号 0 个。
- 天天基金只作净值、申赎、费率等交叉检查；详情见 [`2026-09-07-funds.json`](reports/funds/2026-09-07-funds.json)。
...
> 这是依据 **2026-09-08** 最新证据生成的滚动计划；下一次 `update-readme` 会整体替换本区块，历史判断仍保留在不可变日报中。
