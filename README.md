...
> 数据截点：`2026-08-25T16:30:00+08:00`。状态由 `data/ledger/portfolio.json` 生成；所有金额均为虚拟记录。
...
> 每日策略日期：**2026-08-25**；决策截点：`2026-08-25T16:30:00+08:00`；策略版本：`v0.4.0`。本区块由最新不可变报告自动生成，不再保留首日静态策略。
...
点时输入：[`2026-08-25.json`](data/inbox/2026-08-25.json)。

### 今日策略动作

| 代码 | 标的 | 动作 | 当前权重 | 主要依据 |
|---|---|---:|---:|---|
| 159928 | 汇添富中证主要消费ETF | 买入 | 0.0% | 冷启动趋势信号 |
| 510880 | 华泰柏瑞上证红利ETF | 持有 | 14.7% | 正向趋势信号 |
| 510300 | 华泰柏瑞沪深300ETF | 持有 | 18.4% | `SECURITY_IDENTITY_NOT_CLEARED`；`TERMINATION_RISK_NOT_CLEARED` |
| 510500 | 南方中证500ETF | 持有 | 10.3% | `TREND_NOT_CONFIRMED` |
| 159915 | 易方达创业板ETF | 观察 | 0.0% | 受控回撤信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
| 512100 | 南方中证1000ETF | 观察 | 9.1% | 正向趋势信号；`POSITION_TOO_SMALL_AFTER_DIVERSIFICATION` |
...
决策报告：[`2026-08-25-short.json`](reports/daily/2026-08-25-short.json)。
